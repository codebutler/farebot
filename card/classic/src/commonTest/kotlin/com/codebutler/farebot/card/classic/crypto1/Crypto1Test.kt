...
class Crypto1Test {
    ...
    fun testPrngSuccessor64() {
        ...
        val n2 = 0x01020304u
        val suc96_2 = Crypto1.prngSuccessor(n2, 96u)
        val suc64_2 = Crypto1.prngSuccessor(n2, 64u)
        val suc32of64_2 = Crypto1.prngSuccessor(suc64_2, 32u)
        assertEquals(suc96_2, suc32of64_2)
    }
