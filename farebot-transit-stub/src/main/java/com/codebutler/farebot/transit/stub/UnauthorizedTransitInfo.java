...
/**
 * Handle cards with no open sectors
 */
@AutoValue
public abstract class UnauthorizedTransitInfo extends TransitInfo {

    @NonNull
    public static UnauthorizedTransitInfo create() {
        return new AutoValue_UnauthorizedTransitInfo();
    }
