...
class RicaricaMiTransaction(
    ...
    override val isTapOn get() = (transactionType == TRANSACTION_TAP_ON
    ...
    override val agencyName: String?
        get() = when (transport) {
            RicaricaMiLookup.TRANSPORT_METRO, RicaricaMiLookup.TRANSPORT_TRAM, RicaricaMiLookup.TRANSPORT_BUS -> stringResource.getString(Res.string.ricaricami_agency_atm)
    ...
    override val shortAgencyName: String?
        get() = when (transport) {
            RicaricaMiLookup.TRANSPORT_METRO, RicaricaMiLookup.TRANSPORT_TRAM, RicaricaMiLookup.TRANSPORT_BUS -> stringResource.getString(Res.string.ricaricami_agency_atm_short)
            RicaricaMiLookup.TRANSPORT_TRENORD1 -> stringResource.getString(Res.string.ricaricami_agency_trenord_1)
            RicaricaMiLookup.TRANSPORT_TRENORD2 -> stringResource.getString(Res.string.ricaricami_agency_trenord_2)
            else -> "$transport"
        }
    ...
    companion object {
        ...
        fun parse(tripData: ByteArray, stringResource: StringResource) = RicaricaMiTransaction(
