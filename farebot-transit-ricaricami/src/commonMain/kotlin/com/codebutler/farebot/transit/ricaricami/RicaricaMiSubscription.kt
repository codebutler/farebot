...
class RicaricaMiSubscription(
    ...
    override val remainingTripsInDayCount: Int?
        get() = if (contractTariff == RicaricaMiLookup.TARIFF_URBAN_2X6)
            2 - numValidated
        else null
    ...
    companion object {
        ...
        fun parse(data: ByteArray, counter: ByteArray, xdata: ByteArray, stringResource: StringResource): RicaricaMiSubscription {
