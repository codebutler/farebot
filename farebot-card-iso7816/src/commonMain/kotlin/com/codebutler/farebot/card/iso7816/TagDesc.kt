...
data class TagDesc(
    ...
    fun interpretTag(data: ByteArray): ListItemInterface? =
...
interface TagContentsInterface {
    fun interpretTagString(data: ByteArray): String
    fun interpretTag(name: String, data: ByteArray): ListItemInterface? =
        if (data.isEmpty()) null
        else ListItem(name, interpretTagString(data))
}
...
enum class TagContents : TagContentsInterface {
    ...
    DUMP_LONG {
        override fun interpretTagString(data: ByteArray): String = data.hex()
        override fun interpretTag(name: String, data: ByteArray): ListItemInterface? =
    ...
    HIDE {
        ...
        override fun interpretTag(name: String, data: ByteArray): ListItemInterface? = null
    },
    CURRENCY {
        override fun interpretTagString(data: ByteArray): String {
    ...
    CONTENTS_DATE {
        ...
        override fun interpretTagString(data: ByteArray): String = when (data.size) {
            3 -> {
