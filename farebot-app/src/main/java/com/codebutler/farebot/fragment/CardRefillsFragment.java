...
public class CardRefillsFragment extends ListFragment {
    ...
    private static class RefillsListAdapter extends ArrayAdapter<Refill> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            agencyTextView.setText(refill.getShortAgencyName(getContext().getResources()));
            amountTextView.setText(refill.getAmountString(getContext().getResources()));
