...
public class TripMapActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        actionBar.setTitle(Trip.formatStationNames(this, trip));
        actionBar.setSubtitle((trip.getRouteName(getResources()) == null) ? trip.getAgencyName(getResources())
                : String.format("%s %s", trip.getAgencyName(getResources()), trip.getRouteName(getResources())));
