...
import com.codebutler.farebot.transit.registry.FarebotTransitRegistry
import com.codebutler.farebot.transit.registry.create

class TransitFactoryRegistry(context: Context) {

    private val registry = FarebotTransitRegistry.create(context)
