...
class SeqGoRefill(
    ...
    override fun getTimestamp(): Long {
        return topup.timestamp.toEpochMilliseconds() / 1000
    }
    ...
    override fun getShortAgencyName(stringResource: StringResource): String {
        return stringResource.getString(
            if (topup.automatic) Res.string.seqgo_refill_automatic
            else Res.string.seqgo_refill_manual
        )
    }

    override fun getAmount(): Long {
        return topup.credit.toLong()
    }
    ...
    companion object {
        fun create(topup: SeqGoTopupRecord): SeqGoRefill {
            return SeqGoRefill(topup)
        }
    }
}
