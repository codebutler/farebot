...
abstract class OVChipTrip extends Trip {
    ...
    @NonNull
    static OVChipTrip create(OVChipDBUtil dbUtil, OVChipTransaction transaction) {
        return create(dbUtil, transaction, null);
    }

    @NonNull
    static OVChipTrip create(OVChipDBUtil dbUtil, OVChipTransaction inTransaction, OVChipTransaction outTransaction) {
        ...
        Station startStation = getStation(dbUtil, agency, startStationId);
        ...
        if (outTransaction != null) {
            ...
            if (getStation(dbUtil, agency, outTransaction.getStation()) != null) {
                endStation = getStation(dbUtil, agency, outTransaction.getStation());
            } else {
    ...
    private static Station getStation(@NonNull OVChipDBUtil dbUtil, int companyCode, int stationCode) {
        try {
