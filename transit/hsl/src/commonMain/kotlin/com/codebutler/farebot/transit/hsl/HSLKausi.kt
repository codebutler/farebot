...
class HSLKausi(
    ...
    companion object {
        ...
        private val FIELDS_WALTTI_PRODUCT =
            En1545Container(
        ...
        private val FIELDS_WALTTI_LOAD =
            En1545Container(
                En1545FixedInteger("ProductCode", 14),
                En1545FixedInteger.date(CONTRACT_SALE),
                En1545FixedInteger.timeLocal(CONTRACT_SALE),
        ...
        data class ParseResult(
            val subs: List<HSLKausi>,
            val transaction: HSLTransaction?,
        )

        private fun parseNonZero(
            raw: ByteArray,
            offByte: Int,
            lenByte: Int,
            field: En1545Container,
        ): En1545Parsed? {
