...
/**
 * Transit data type for Waikato-region cards (BUSIT / SmartRide Rotorua, New Zealand).
 *
 * These cards are used for bus transit in Hamilton (Waikato) and Rotorua.
 *
