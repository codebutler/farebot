...
class RkfTransaction(
    ...
    override val eventType get() =
        if (mTransactionCode == 0xf) {
            parsed.getIntOrZero(TRANSACTION_TYPE)
        } else {
            mTransactionCode
        }
    ...
    companion object {
        ...
        // From Rejsekort
        private val FIELDS_V2_HEADER =
            En1545Container(
                En1545FixedInteger("Identifier", 8),
                En1545FixedInteger.date(EVENT),
                En1545FixedInteger.timePacked16(EVENT),
            )
        private val FIELDS_V2_BLOCK1_COMMON =
            En1545Container(
                En1545FixedInteger(EVENT_SERVICE_PROVIDER, 12),
                // Rest unknown
            )

        private val FIELDS_V2_BLOCK1_TYPE_F =
            En1545Container(
        ...
        private fun parseTransactionV1(
            b: ByteArray,
            lookup: RkfLookup,
        ): RkfTransaction? {
        ...
        private fun parseTransactionV2(
            b: ByteArray,
            lookup: RkfLookup,
        ): RkfTransaction? {
