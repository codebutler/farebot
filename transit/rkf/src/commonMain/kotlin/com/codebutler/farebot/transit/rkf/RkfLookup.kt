...
import farebot.transit.rkf.generated.resources.rkf_stockholm_30_days
import farebot.transit.rkf.generated.resources.rkf_stockholm_72_hours
import farebot.transit.rkf.generated.resources.rkf_stockholm_7_days
import kotlinx.datetime.TimeZone
import org.jetbrains.compose.resources.StringResource

private const val STR = "rkf"

data class RkfLookup(
    val mCurrencyCode: Int,
    val mCompany: Int,
) : En1545LookupSTR(STR) {
    override fun parseCurrency(price: Int): TransitCurrency {
        val intendedDivisor =
            when (mCurrencyCode shr 12) {
                0 -> 1
                1 -> 10
                2 -> 100
                9 -> 2
    ...
    override val timeZone: TimeZone get() =
        when (mCompany / 1000) {
    ...
    override val subscriptionMapByAgency: Map<Pair<Int?, Int>, StringResource> get() =
        mapOf(
    ...
    companion object {
         ...
         */
        private fun iso4217NumericToAlpha(numericCode: Int): String =
            when (numericCode) {
