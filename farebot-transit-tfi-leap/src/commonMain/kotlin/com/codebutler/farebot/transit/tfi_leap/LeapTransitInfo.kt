...
import farebot.farebot_transit_tfi_leap.generated.resources.transit_leap_accumulator_agency
import farebot.farebot_transit_tfi_leap.generated.resources.transit_leap_accumulator_region
import farebot.farebot_transit_tfi_leap.generated.resources.transit_leap_accumulator_total
import farebot.farebot_transit_tfi_leap.generated.resources.transit_leap_card_issuer
import farebot.farebot_transit_tfi_leap.generated.resources.transit_leap_card_name
import farebot.farebot_transit_tfi_leap.generated.resources.transit_leap_daily_accumulators
import farebot.farebot_transit_tfi_leap.generated.resources.transit_leap_initialisation_date
...
class LeapTransitInfo(
    ...
    companion object {
        ...
        fun parseDate(file: ByteArray, offset: Int): Instant {
            val sec = file.byteArrayToInt(offset, 4)
            return Instant.fromEpochSeconds(LEAP_EPOCH.epochSeconds + sec.toLong())
        }

        fun parseBalance(file: ByteArray, offset: Int): Int {
            return file.getBitsFromBufferSigned(offset * 8, 24)
        }

        internal fun chooseBlock(file: ByteArray, txidoffset: Int): Int {
        ...
        internal fun getSerial(file2: ByteArray, file6: ByteArray): String {
...
class AccumulatorBlock(
    ...
    fun toListItems(): List<ListItemInterface> {
        ...
        for ((agency, value) in accumulators) {
            if (value != 0) {
                val operatorName = MdstStationLookup.getOperatorName(
                    LeapTrip.LEAP_STR, agency
                ) ?: agency.toString()
                items.add(
                    ListItem(
