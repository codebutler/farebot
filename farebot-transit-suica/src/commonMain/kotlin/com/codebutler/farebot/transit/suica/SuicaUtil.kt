...
internal object SuicaUtil {
     ...
     */
    fun getCardName(stringResource: StringResource, serviceCodes: Set<Int>): String {
    ...
    fun extractDate(isProductSale: Boolean, data: ByteArray): Instant? {
     ...
     */
    fun getConsoleTypeName(stringResource: StringResource, cType: Int): String {
        return when (cType and 0xff) {
     ...
     */
    fun getProcessTypeName(stringResource: StringResource, proc: Int): String {
        return when (proc and 0xff) {
    ...
    fun getBusStop(regionCode: Int, lineCode: Int, stationCode: Int): Station? {
        ...
        return Station.unknown(
            "${NumberUtils.intToHex(regionCode)}/${NumberUtils.intToHex(lineCodeLow)}/${NumberUtils.intToHex(stationCodeLow)}"
        )
    }
