...
class FlipperIntegrationTest {
    ...
    @Test
    fun testFullFlowConnectListReadFile() = runTest {
        ...
        val listContent = buildStorageListResponseBytes(
            listOf(
    ...
    @Test
    fun testFullFlowConnectReadKeyDictionary() = runTest {
        val transport = MockTransport()
        val client = FlipperRpcClient(transport)
    ...
    @Test
    fun testMultiChunkFileRead() = runTest {
        val transport = MockTransport()
        val client = FlipperRpcClient(transport)
    ...
    @Test
    fun testDisconnectCleansUp() = runTest {
        val transport = MockTransport()
        val client = FlipperRpcClient(transport)
